...
use Vdm\Bundle\PrometheusBundle\Monitoring\Collector\Opcache\StatsManualRestartsCollector;

class StatsManualRestartsCollectorTest extends TestCase
{
    public function testGetCollectorName()
    {
        $collector = new StatsManualRestartsCollector();
        $this->assertEquals(StatsManualRestartsCollector::COLLECTOR_NAME, $collector->getCollectorName());
    }

    public function testGetCollectorDescription()
    {
        $collector = new StatsManualRestartsCollector();
        $this->assertEquals(StatsManualRestartsCollector::COLLECTOR_DESCRIPTION, $collector->getCollectorDescription());
    }
