...
use Vdm\Bundle\PrometheusBundle\Monitoring\Collector\Opcache\InternedStringsFreeCollector;

class InternedStringsFreeCollectorTest extends TestCase
{
    public function testGetCollectorName()
    {
        $collector = new InternedStringsFreeCollector();
        $this->assertEquals(InternedStringsFreeCollector::COLLECTOR_NAME, $collector->getCollectorName());
    }

    public function testGetCollectorDescription()
    {
        $collector = new InternedStringsFreeCollector();
        $this->assertEquals(InternedStringsFreeCollector::COLLECTOR_DESCRIPTION, $collector->getCollectorDescription());
    }
