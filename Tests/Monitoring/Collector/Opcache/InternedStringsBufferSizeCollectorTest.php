...
use Vdm\Bundle\PrometheusBundle\Monitoring\Collector\Opcache\InternedStringsBufferSizeCollector;

class InternedStringsBufferSizeCollectorTest extends TestCase
{
    public function testGetCollectorName()
    {
        $collector = new InternedStringsBufferSizeCollector();
        $this->assertEquals(InternedStringsBufferSizeCollector::COLLECTOR_NAME, $collector->getCollectorName());
    }
